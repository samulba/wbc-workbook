...
export const STEP_CONFIG = [
  ...
  { step: 5, title: "Inspiration für deine Wirkung", subtitle: "Design-Merkmale",      built: true, kind: "learning"    as StepKind },
  { step: 6, title: "KI-Raumanalyse",                subtitle: "Optional – mit Foto",  built: true, kind: "interactive" as StepKind },
] as const;
