  ...
  return (
    <div className="flex flex-col gap-8">
        ...
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <a
              ...
              className={cn(
                "flex items-center justify-between rounded-xl border border-sand/35",
                "bg-white/50 px-4 py-3 transition-all group",
                "hover:border-forest/25 hover:bg-forest/5"
              )}
            >
              <div>
              ...
              <ExternalLink
                className="w-3.5 h-3.5 text-gray/30 group-hover:text-forest/40 transition-colors"
                strokeWidth={1.5}
              />
            </a>
          ))}
      ...
      <div className="flex flex-col gap-3">
        <div>
          <h3 className="font-headline text-base text-forest mb-0.5">
            Moodboard hochladen
          </h3>
